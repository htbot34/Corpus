...
ACKNOWLEDGEMENTS = {
    "thanks", "thank you", "thanks so much", "thank you so much", "ty", "thx",
    "yes", "yep", "yup", "no", "nope", "agreed", "agree", "same", "true",
    "this", "exactly", "correct", "right", "indeed", "seconded", "ditto",
    "congrats", "congratulations", "welcome", "you're welcome", "np",
    "nice", "cool", "wow", "lol", "haha", "lmao", "ha", "heh", "ok", "okay",
    "sorry", "oops", "done", "fixed", "noted", "sure", "of course", "amen",
    "rip", "sad", "yikes", "hmm", "wat", "what", "huh",
}
